...
- **Probabilidade de conclusão no prazo**: 75.0%
...
|------|---------------|---------|------------|
| qua., 20/11/2024 | 75.0% | ❌ Atraso Crítico | 📍 Data mais provável |
...
# Metricas
## Throughput
![Exemplo de SVG](./charts/throughput-25.svg)
##  Cumulate Flow
![Exemplo de SVG](./charts/cfd-25.svg)
